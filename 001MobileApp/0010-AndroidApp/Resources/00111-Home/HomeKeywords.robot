*** Settings ***
Resource           ../../../../001MobileApp/0010-AndroidApp/Resources/000-Common/CommonKeywords.robot

Library     SeleniumLibrary
Resource    ./HomeLocators.robot
Resource    ./HomeAssertions.robot
Resource    ../../../../002Web/Resources/Wallet/WalletKeywords.robot
#Library    OperatingSystem
#Library    String
#Library    Collections
Library    pyperclip
Resource   ../000-Common/CommonKeywords.robot
...
#Resource    ../008-SharedModules/0011-Header/001111-CreatePostAndStore/0011111-CreatePost/CreatePostKeyWords.robot
...
Verify Home Page Loaded
        ...
        AppiumLibrary.wait until element is visible      ${FOLLOWING_TAB}
